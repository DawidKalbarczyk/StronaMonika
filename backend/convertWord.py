...
def czytaj_word():
    ...
    for plik in pliki:
        ...
        # Część 1: akapity pisane CAPS LOCK (bez punktorów i cyfr) – konwertujemy do Title Case
        czesc_1 = [a.title() for a in akapity if a.upper() == a and a.strip() and not a.strip().startswith(('*', '-', '1', '2', '3', '4', '5', '6', '7', '8', '9'))]
